...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 64, 156, 241),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  foregroundColor: Color.fromARGB(255, 64, 156, 241),
                ),
              )
            ],
          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(categories[index]["icono"],
                              size: 40.0, color: Color.fromARGB(255, 0, 0, 0)),
                          SizedBox(height: 5.0), 
                          Text(
                            categories[index]['titulo'],
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(fontSize: 12.0, color: Color.fromARGB(255, 0, 0, 0)),
                          ),
                        ],
                      ),
                    ),
...
final List<Map<String, dynamic>> categories = [
  {'codigo': '001', 'icono': Icons.house, 'titulo': 'Hogar y muebles'},
  {'codigo': '002', 'icono': Icons.app_shortcut_outlined, 'titulo': 'Celulares'},
  ...
  {'codigo': '007', 'icono': Icons.help, 'titulo': 'Herramientas'},
  {'codigo': '008', 'icono': Icons.auto_fix_high_outlined, 'titulo': 'Belleza'},
